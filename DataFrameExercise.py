...
"""
c = exams[exams.iloc[:, 2] > 2]
c1 = exams[exams["attempts"] > 2]
print()
"""
...
"""
d = exams[(exams.iloc[:, 1] >= 15) & (exams.iloc[:, 1] <= 20)]
print(d)
"""
...
"""
e = exams.sort_values(["attempts", "name"])
print(e)
